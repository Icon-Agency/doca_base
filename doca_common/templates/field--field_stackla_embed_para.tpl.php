...
<?php if (!empty($stackla_arr['field_short_title']['#items'][0]['value'])): ?>
  <div id="stackla-title"
       class="stackla-title layout-max">
    <h2><?php print $stackla_arr['field_short_title']['#items'][0]['value']; ?></h2>
  </div>
    <div class="stacklafw stacklafw-with-heading layout-max--sm-med-lrg panel-background-2"
<?php else: ?>
